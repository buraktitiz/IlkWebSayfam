...
/* Codepen ile deneyimleyebiliriz! Bir hesap makinesine dönüştürmeden önce kare alma ve kök alma case'lerini sizin ekleyelim
...
console.log(islem(3, 'karesi'));  //9
console.log(islem(4, 'küpü'));  //64
console.log(islem(4, 'deneme')); // 'Tanimlanmamis islem'
